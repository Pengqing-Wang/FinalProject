...
public class USD_to_GBP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usd_to__gbp);
        Button convert = findViewById(R.id.convertButton);
        convert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText numEntered = (EditText) findViewById(R.id.gbpenter);
    ...
    void processResponse(final JSONObject response, final Double amountEntered) {
        try {
            Double exchangeRate = response.getJSONObject("quotes").getDouble("USDGBP");
            Double convertedAmount = amountEntered * exchangeRate;
            TextView gbpoutput = (TextView) findViewById(R.id.gbpoutput);
            gbpoutput.setText(convertedAmount.toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
