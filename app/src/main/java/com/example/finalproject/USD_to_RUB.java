...
public class USD_to_RUB extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usd_to__rub);
        Button convert = findViewById(R.id.convertButton);
        convert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText numEntered = (EditText) findViewById(R.id.rubenter);
    ...
    void processResponse(final JSONObject response, final Double amountEntered) {
        try {
            Double exchangeRate = response.getJSONObject("quotes").getDouble("USDRUB");
            Double convertedAmount = amountEntered * exchangeRate;
            TextView ruboutput = (TextView) findViewById(R.id.ruboutput);
            ruboutput.setText(convertedAmount.toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
