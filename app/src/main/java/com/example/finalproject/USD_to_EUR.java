...
public class USD_to_EUR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_usd_to__eur);
        Button convert = findViewById(R.id.convertButton);
        convert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditText numEntered = (EditText) findViewById(R.id.eurenter);
    ...
    void processResponse(final JSONObject response, final Double amountEntered) {
        try {
            ...
            TextView euroutput = (TextView) findViewById(R.id.euroutput);
            euroutput.setText(convertedAmount.toString());
        } catch (Exception e) {
            e.printStackTrace();
        }
}
